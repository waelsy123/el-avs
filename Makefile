...
# check in contracts/script/output/${CHAINID}/lending_protocol_avs_deployment_output.json
...
deploy-all: ## Build and deploy all contracts
	make build-contracts
	make deploy-eigenlayer-contracts-to-anvil-and-save-state
	make deploy-lending-protocol-contracts-to-anvil-and-save-state
	make start-operator
...
deploy-lending-protocol-contracts-to-anvil-and-save-state: ## Deploy avs
	./utils/anvil/deploy-avs-save-anvil-state.sh

deploy-contracts-to-anvil-and-save-state: deploy-eigenlayer-contracts-to-anvil-and-save-state deploy-lending-protocol-contracts-to-anvil-and-save-state ## deploy eigenlayer, shared avs contracts, and inc-sq contracts (part of quickstart)
...
# start-chain-and-deploy-lending-protocol-avs: build-contracts deploy-contracts-to-anvil-and-save-state start-anvil-chain-with-el-and-avs-deployed
